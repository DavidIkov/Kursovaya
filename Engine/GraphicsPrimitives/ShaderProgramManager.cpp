...
ShaderProgramID ShaderProgramManager::GetShaderProgramIDByName(std::string name) {
...
ShaderProgramID ShaderProgramManager::AddShaderProgram(std::string name, ShaderProgram* prog) {
	Names.push_back(name);
	IDBasedVectorElementID id = ShaderPrograms.Insert({ name,prog });;
	IDs.push_back(id);
	return id;
}
void ShaderProgramManager::RemoveShaderProgram(ShaderProgramID id) {
